...
class AssignmentSubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment_submission" do
    assert_difference("AssignmentSubmission.count") do
      post assignment_submissions_url, params: { assignment_submission: { assignment_id: @assignment_submission.assignment_id, attempt_number: @assignment_submission.attempt_number, date_submitted: @assignment_submission.date_submitted, feedback: @assignment_submission.feedback, grade: @assignment_submission.grade, student_id: @assignment_submission.student_id } }
    end
